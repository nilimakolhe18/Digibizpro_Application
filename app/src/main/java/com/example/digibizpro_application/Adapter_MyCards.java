...
public class Adapter_MyCards extends RecyclerView.Adapter<Adapter_MyCards.UserHolder> {
        Context context;
        ArrayList mAddNameArrayList;

public Adapter_MyCards(Context context, ArrayList mAddNameArrayList) {
...
@NonNull
@Override
public Adapter_MyCards.UserHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_my_cards, null);
